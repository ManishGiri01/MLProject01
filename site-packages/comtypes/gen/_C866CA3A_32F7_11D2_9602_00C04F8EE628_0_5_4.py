...
__all__ = [
    'DISPID_SRCEBookmark', 'DISPID_SRGCmdSetRuleState', 'SRARoot',
    'SP_VISEME_20', 'DISPID_SGRSTransitions',
    'SpeechPropertyResponseSpeed', 'ISpPhraseAlt', 'DISPID_SOTId',
    'SPEI_VISEME', 'SpMemoryStream', 'ISpeechPhraseProperty',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPERetainedSizeBytes',
    'SPSLMA', 'SPBO_TIME_UNITS', 'DISPID_SRCRecognizer',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRGCommit',
    'DISPID_SGRSAddSpecialTransition', 'SREAdaptation',
    'SpeechGrammarState', 'DISPID_SPEPronunciation', 'SPXRO_SML',
    'DISPID_SOTCategory', 'SPRECOGNIZERSTATUS', 'SVP_18',
    'SPSSuppressWord', 'ISpeechPhraseRule', 'SpeechTokenContext',
    'DISPIDSPTSI_SelectionLength', 'SAFTNonStandardFormat',
    'IEnumString', 'SPAS_STOP', 'DISPID_SRAudioInput',
    'eLEXTYPE_PRIVATE2', 'SSSPTRelativeToStart', 'SITooLoud',
    'SAFT48kHz8BitStereo', 'DISPID_SPIAudioStreamPosition',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRGState',
    'DISPID_SRGDictationUnload', 'DISPID_SPCLangId',
    'SpeechVisemeType', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPRuleEngineConfidence', 'SECLowConfidence',
    'DISPID_SREmulateRecognition', 'SPDKL_DefaultLocation',
    'SPVPRI_NORMAL', 'DISPID_SRCRequestedUIType',
    ...
    'SSTTTextBuffer', 'SVESentenceBoundary', 'SP_VISEME_4',
    'DISPID_SRCERecognition', 'SPCONTEXTSTATE',
    'DISPID_SRRTTickCount', 'ISpeechObjectTokens', 'tagSTATSTG',
    'DISPID_SRIsShared', 'ISpAudio', 'SSSPTRelativeToCurrentPosition',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPAStartElementInResult', 'DISPID_SPPFirstElement',
    'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechPropertyResourceUsage', 'DISPID_SpeechPhraseReplacement',
    'SGRSTTRule', 'SPPS_Function', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SRCEPropertyStringChange', 'SPDKL_LocalMachine',
    'SpSharedRecoContext', 'SP_VISEME_1', 'DISPID_SPIProperties',
    'ISpeechAudio', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SPRs_NewEnum', 'SAFTADPCM_8kHzMono',
    'DISPID_SGRAttributes', 'DISPID_SpeechMMSysAudio',
    'SpeechRetainedAudioOptions', 'SRERequestUI', 'ISpRecognizer',
    'SGSExclusive', 'SPRS_ACTIVE_USER_DELIMITED', 'SPBO_PAUSE',
    'DISPID_SWFEAvgBytesPerSec', 'SPSHT_OTHER', 'DISPID_SVEBookmark',
    'SPEI_HYPOTHESIS', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SMSSetData', 'DISPID_SOTDataKey', 'DISPID_SRGRecoContext',
    'SPEI_END_SR_STREAM', 'DISPID_SpeechCustomStream',
    'DISPID_SRCResume', 'DISPID_SVStatus', 'SDTProperty',
    'DISPID_SRCERequestUI', 'DISPID_SpeechPhraseProperties',
    'SpeechGrammarTagDictation', 'SAFTExtendedAudioFormat',
    'SPVOICESTATUS', 'ISpPhoneConverter', 'eLEXTYPE_RESERVED4',
    'DISPID_SGRSTPropertyValue', 'ISpObjectToken',
    'SDA_Two_Trailing_Spaces', 'SAFT8kHz16BitMono',
    'DISPID_SVEStreamStart', 'DISPID_SGRSTType',
    'DISPID_SPIAudioSizeTime', 'SPAUDIOOPTIONS',
    'DISPID_SVSInputWordPosition', 'DISPID_SPEActualConfidence',
    'SPWORD', 'ISpStreamFormatConverter', 'ISpeechRecoResult',
    'ISpeechTextSelectionInformation', 'DISPID_SPRuleChildren',
    'DISPID_SRRGetXMLErrorInfo', 'SPPS_Noncontent',
    'SpeechCategoryAppLexicons', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SpeechRecoContext', 'SRTReSent', 'DISPID_SWFEExtraData',
    'SpeechTokenShellFolder', '__MIDL_IWinTypes_0009',
    'SPGRAMMARSTATE', 'SPEI_RESERVED3', 'DISPID_SGRAddState',
    'SWTDeleted', 'ISpeechLexiconWords',
    'ISpeechLexiconPronunciations', 'SPEI_SR_AUDIO_LEVEL',
    'SPPS_RESERVED4', 'SAFT44kHz16BitStereo', 'SpAudioFormat',
    'ISpeechFileStream', 'SAFTCCITT_uLaw_11kHzStereo',
    'SAFT16kHz16BitStereo', 'SPINTERFERENCE_TOOFAST',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSAddRuleTransition',
    'ISpeechBaseStream', 'DISPID_SLWPronunciations', 'SPRS_ACTIVE',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPACommit',
    'ISpeechLexiconWord', 'DISPID_SABufferInfo',
    'DISPID_SCSBaseStream', 'SRCS_Disabled', 'DISPID_SPIReplacements',
    'DISPID_SVAudioOutputStream', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechVoice', 'DISPID_SVRate',
    'DISPID_SGRId', 'SPSFunction', 'DISPID_SRIsUISupported',
    'DISPID_SRCCreateResultFromMemory',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFT32kHz16BitMono',
    '_RemotableHandle', 'Speech_StreamPos_RealTime',
    'SSFMOpenReadWrite', 'SVP_11', 'DISPID_SMSGetData',
    'SPPS_NotOverriden', 'DISPID_SPIGetDisplayAttributes',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPID_SPPs_NewEnum',
    'SPAUDIOSTATUS', 'SECFDefault', 'eLEXTYPE_RESERVED6',
    'DISPID_SOTCEnumerateTokens', 'SPEI_START_SR_STREAM',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SpeechPhraseInfo',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SPPEngineConfidence', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SDKSetLongValue', 'SPSModifier', 'ISpeechRecoContext',
    'SP_VISEME_6', 'ISpNotifySink',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SASFreeBufferSpace', 'SRADynamic',
    'DISPID_SRCEInterference', 'SpStream', 'SPDKL_CurrentUser',
    'DISPID_SPAsCount', 'SpeechCategoryRecognizers',
    'IInternetSecurityMgrSite', 'SVP_8',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPWT_DISPLAY',
    'SP_VISEME_10', 'DISPID_SRGRules', 'SAFT11kHz16BitMono',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVSCurrentStreamNumber',
    'SPEI_SENTENCE_BOUNDARY', 'SVSFParseAutodetect',
    'DISPID_SVESentenceBoundary', 'SVEAllEvents',
    'eLEXTYPE_PRIVATE16', 'SAFTADPCM_11kHzStereo', 'SpMMAudioEnum',
    'SPAUDIOBUFFERINFO', 'SPEI_PHONEME', 'SPEI_MAX_TTS',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechGrammarRule',
    'DISPID_SRDisplayUI', 'ISpResourceManager', 'SPWT_PRONUNCIATION',
    'SVSFDefault', 'SAFTADPCM_22kHzMono', 'SWTAdded',
    'SPGRAMMARWORDTYPE', 'SpMMAudioIn', 'ISpeechCustomStream',
    'STCRemoteServer', 'ISpRecoCategory', 'DISPID_SpeechFileStream',
    'SP_VISEME_0', 'DISPID_SRGCmdLoadFromFile', 'SREInterference',
    'SAFTDefault', 'SITooQuiet', 'ISpPhoneticAlphabetSelection',
    'DISPID_SAVolume', 'SPCT_DICTATION',
    'DISPID_SOTRemoveStorageFileName', 'SpeechTokenKeyAttributes',
    'ISpeechPhraseRules', 'SPFILEMODE', 'SAFT44kHz8BitStereo',
    'DISPID_SMSAMMHandle', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SBSWrite', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SOTCreateInstance',
    'SpPhoneConverter', 'DISPID_SPEAudioSizeTime',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SpeechObjectTokenCategory', 'SPPS_Interjection',
    'DISPID_SpeechBaseStream', 'DISPID_SAEventHandle',
    'DISPID_SRCVoice', 'SPEI_SR_PRIVATE', 'SGDSActive', 'SVEViseme',
    'ISpLexicon', 'DISPID_SGRSTText', 'SPVISEMES', 'SPPROPERTYINFO',
    'SRSActiveAlways', 'ISpStreamFormat', 'SPADAPTATIONRELEVANCE',
    'SAFTGSM610_44kHzMono', 'SRERecognition', 'SSFMOpenForRead',
    'DISPID_SDKEnumValues', 'SpeechRecoProfileProperties',
    'ISpRecoGrammar2', 'DISPID_SRCEAudioLevel',
    'SPRST_INACTIVE_WITH_PURGE', 'SAFT44kHz16BitMono',
    'ISpeechPhraseAlternates', 'SREFalseRecognition',
    'SpeechRecoEvents', 'SpeechVoiceSpeakFlags', 'SVSFNLPMask',
    'DISPID_SVSInputSentencePosition', 'ISpObjectWithToken',
    'DISPID_SDKDeleteValue', 'eLEXTYPE_MORPHOLOGY',
    'SPAO_RETAIN_AUDIO', 'DISPID_SPIEnginePrivateData',
    'SP_VISEME_19', 'eLEXTYPE_PRIVATE14', 'DISPID_SRRAlternates',
    'SRAInterpreter', 'DISPID_SGRSTPropertyId', 'eWORDTYPE_DELETED',
    'DISPID_SOTDisplayUI', 'DISPID_SRCEPropertyNumberChange',
    'SREPhraseStart', 'DISPID_SpeechAudioFormat',
    'SAFT24kHz16BitMono', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRGSetTextSelection', 'ISpeechLexiconPronunciation',
    'DISPID_SpeechAudio', 'SSFMCreate', 'SpeechStreamFileMode',
    'DISPID_SVPriority', 'DISPID_SpeechPhraseElements', 'SRSActive',
    'DISPID_SpeechPhraseAlternate', 'ISpeechPhraseInfo', 'SVP_15',
    'DISPID_SOTsItem', 'SAFTCCITT_ALaw_11kHzMono', 'SRSInactive',
    'SAFT8kHz16BitStereo', 'DISPID_SVAlertBoundary', 'SFTSREngine',
    'SVP_16', 'DISPID_SRRAudioFormat', 'IStream',
    'SAFT32kHz8BitStereo', 'DISPID_SFSOpen', 'SPEI_ADAPTATION',
    'DISPID_SPANumberOfElementsInResult', 'SWPKnownWordPronounceable',
    'SRERecoOtherContext', 'SpeechTokenKeyFiles',
    'DISPID_SRRPhraseInfo', 'DISPID_SRCESoundStart',
    'DISPID_SGRsCommit', 'SAFT12kHz16BitMono', 'ISpRecognizer2',
    'ISpeechXMLRecoResult', 'SDKLCurrentUser', 'SVP_19',
    'SPPARTOFSPEECH', 'SAFT8kHz8BitStereo', 'DISPID_SVGetProfiles',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SLPsItem',
    'DISPID_SPCPhoneToId', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SpeechDataKey', 'DISPID_SpeechVoiceStatus', 'SPSNoun',
    'SVP_13', 'SpPhoneticAlphabetConverter',
    'DISPID_SPRuleFirstElement', 'DISPID_SRRSaveToMemory',
    'DISPID_SPPParent', 'SRSInactiveWithPurge', 'DISPID_SGRSTsItem',
    'SPCT_SUB_DICTATION', 'DISPID_SAStatus', 'SPPS_RESERVED3',
    'SPPHRASEREPLACEMENT', 'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPPId',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE3', 'SINone',
    'eLEXTYPE_APP', 'SP_VISEME_3', 'SRCS_Enabled',
    'SpeechRecognitionType', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SRCEEnginePrivate', 'SAFT32kHz8BitMono',
    'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SMSADeviceId',
    'eLEXTYPE_RESERVED9', 'DISPID_SVSpeakCompleteEvent',
    'SpCompressedLexicon', 'DISPIDSPTSI_SelectionOffset',
    'SPINTERFERENCE', 'DISPID_SDKGetBinaryValue',
    'SVEStartInputStream', 'SAFT8kHz8BitMono', 'SP_VISEME_12',
    'DISPID_SpeechPhraseProperty', 'SpeechDisplayAttributes',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SLGetGenerationChange',
    'SRSEDone', 'STCLocalServer', 'WAVEFORMATEX',
    'DISPID_SPILanguageId', 'DISPID_SGRSTsCount',
    'eLEXTYPE_PRIVATE20', 'SVEBookmark', 'SpeechRecoContextState',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SVEVoiceChange',
    'SVSFNLPSpeakPunc', 'SpeechCategoryRecoProfiles', 'SREStreamEnd',
    'DISPID_SRGetFormat', 'SpeechRuleState', 'ISpeechObjectToken',
    'DISPID_SRGetPropertyNumber', 'DISPID_SRCEventInterests',
    'SVP_17', 'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SOTs_NewEnum',
    'SVSFVoiceMask', 'SPEI_PROPERTY_STRING_CHANGE',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SASState', 'SpeechBookmarkOptions',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SVEAudioLevel',
    'DISPID_SRCEHypothesis', 'ISpPhrase', 'eWORDTYPE_ADDED',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SOTIsUISupported',
    'DISPID_SRRTLength', 'SpObjectTokenCategory',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVEventInterests',
    'DISPID_SGRsDynamic', 'SDTAll', 'DISPID_SPRulesItem',
    'ISpeechGrammarRuleStateTransitions', 'SGDSActiveUserDelimited',
    'SPEI_INTERFERENCE', 'SASRun', 'SPSVerb', 'SPEI_REQUEST_UI',
    'DISPID_SRSetPropertyNumber', 'DISPID_SpeechAudioStatus',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SOTCSetId', 'SPAR_Unknown',
    'SAFT48kHz16BitMono', 'SREPropertyNumChange',
    'SpeechTokenIdUserLexicon', 'ISpNotifyTranslator',
    'SAFT16kHz8BitStereo', 'DISPID_SVIsUISupported',
    'SpeechRuleAttributes', 'STSF_CommonAppData', 'SVP_21',
    'SPBO_NONE', 'SAFT11kHz8BitMono', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechRecoResult', 'Speech_Default_Weight',
    'SAFT16kHz16BitMono', 'STCInprocHandler', 'SLTUser',
    'DISPID_SpeechLexiconProns', 'DISPID_SDKOpenKey',
    'DISPID_SPRDisplayAttributes', 'SFTInput', 'SVSFParseSapi',
    '_ISpeechRecoContextEvents', 'SpeechAudioProperties',
    'SSTTDictation', 'DISPID_SGRs_NewEnum', 'SpInProcRecoContext',
    'SpeechCategoryAudioOut', 'SpeechTokenKeyUI',
    'DISPID_SRCSetAdaptationData', 'ISpeechAudioStatus',
    'SPDKL_CurrentConfig', 'SAFT24kHz8BitMono', 'SP_VISEME_9',
    'DISPID_SRRAudio', 'DISPID_SLWs_NewEnum', 'SPWORDPRONUNCIATION',
    'DISPID_SPISaveToMemory', 'SVEVoiceChange',
    'DISPID_SADefaultFormat', 'ISpRecoContext2',
    'ISpeechAudioBufferInfo', 'SREStateChange', 'DISPID_SOTCId',
    'SPSHORTCUTPAIRLIST', 'DISPID_SPEs_NewEnum', 'SVEPhoneme',
    'SPRST_INACTIVE', 'SpeechPropertyAdaptationOn',
    'DISPID_SOTsCount', 'SP_VISEME_5', 'STSF_FlagCreate',
    'SpeechDictationTopicSpelling', 'ISpShortcut', 'SRTAutopause',
    'SPEI_MIN_TTS', 'DISPID_SRCESoundEnd', 'DISPID_SLPLangId',
    'SAFTCCITT_ALaw_8kHzStereo', 'SVPNormal', 'SINoise',
    'DISPID_SRRSetTextFeedback', 'ISpEventSource',
    'DISPID_SLPPhoneIds', 'SpInprocRecognizer', 'SLODynamic',
    'SVP_20', 'SPPS_SuppressWord', 'SpeechGrammarWordType',
    'ISpRecoResult', 'SDTPronunciation', 'DISPID_SVGetAudioInputs',
    'DISPID_SPPValue', 'SPAR_Low', 'SPPHRASE',
    'DISPID_SLGetPronunciations', 'SpeechAddRemoveWord',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechPhraseAlternate',
    'DISPID_SLWsItem', 'SDKLLocalMachine',
    'DISPID_SPRNumberOfElements', 'SECFIgnoreKanaType',
    'SECFEmulateResult', 'DISPID_SASCurrentSeekPosition',
    'SpeechAllElements', 'SAFT22kHz8BitStereo', 'SPRULESTATE',
    'DISPID_SRSetPropertyString', 'DISPID_SPRsCount', 'SPAS_PAUSE',
    'SpTextSelectionInformation', 'SPINTERFERENCE_NOSIGNAL',
    'SVSFParseMask', 'ISpRecoContext', 'DISPID_SpeechLexiconWords',
    'ISpeechGrammarRuleStateTransition', 'SAFT24kHz8BitStereo',
    'SpeechSpecialTransitionType', 'SPRST_NUM_STATES',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SAFT11kHz8BitStereo',
    'DISPID_SPPChildren', 'DISPID_SVSInputWordLength',
    'STCInprocServer', 'DISPID_SRSAudioStatus', 'DISPID_SRGReset',
    'SpeechFormatType', 'DISPID_SVEEnginePrivate',
    'SSFMCreateForWrite', 'DISPID_SPIGrammarId',
    'DISPID_SVSLastBookmarkId', 'SECFNoSpecialChars',
    'SAFT22kHz16BitMono', 'SPSMF_UPS', 'DISPID_SRCRetainedAudio',
    'DISPID_SVVolume', 'SPAO_NONE',
    'SpeechPropertyHighConfidenceThreshold',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPARecoResult',
    'DISPID_SGRsCount', 'SpeechAudioFormatGUIDWave',
    'DISPID_SAFSetWaveFormatEx', 'SRTEmulated',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTSetId',
    'eLEXTYPE_PRIVATE5', 'SPWORDPRONOUNCEABLE', 'SPFM_OPEN_READONLY',
    'SRAORetainAudio', 'SITooSlow', 'DISPID_SRRSpeakAudio',
    'DISPID_SPRuleId', 'SpeechWordType', 'SpSharedRecognizer',
    'SPCATEGORYTYPE', 'SPXRO_Alternates_SML', '_ISpeechVoiceEvents',
    'DISPID_SVEStreamEnd', 'SPEI_TTS_BOOKMARK', 'SPEI_UNDEFINED',
    'SpeechRunState', 'SVP_10', 'SAFT12kHz8BitStereo',
    'DISPID_SPIGetText', 'DISPID_SVEPhoneme', 'ISpeechLexicon',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRGIsPronounceable',
    'DISPID_SVSLastBookmark', 'SP_VISEME_7', 'SPGS_DISABLED',
    'DISPID_SOTGetStorageFileName', 'SVPOver',
    'SpUnCompressedLexicon', 'SpeechMicTraining',
    'DISPID_SASNonBlockingIO', 'SDTAudio',
    'DISPID_SPEEngineConfidence', 'DISPID_SVEWord',
    'SPEI_TTS_PRIVATE', 'DISPID_SpeechGrammarRules',
    'SPSEMANTICFORMAT', 'SAFT11kHz16BitStereo',
    'SAFTGSM610_22kHzMono', 'SAFTCCITT_uLaw_8kHzStereo',
    'SREAudioLevel', 'SGPronounciation', 'SVSFParseSsml',
    'SPCT_SUB_COMMAND', 'SPPS_LMA', 'SITooFast',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPAS_CLOSED',
    'DISPID_SRGId', 'SECNormalConfidence', 'SVSFUnusedFlags',
    'eLEXTYPE_USER', 'DISPID_SABIEventBias', 'SPAUDIOSTATE', 'SVP_7',
    'eLEXTYPE_PRIVATE11', 'SPWORDTYPE', 'DISPID_SRCPause',
    'SGDisplay', 'SpeechEngineProperties', 'DISPID_SDKCreateKey',
    'ISpeechPhraseProperties', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechUserTraining', 'SASPause', 'SRSEIsSpeaking', 'SREPrivate',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SRGDictationLoad',
    'SAFT44kHz8BitMono', 'ISpNotifySource', 'SPEI_RESERVED2',
    'DISPID_SGRSTs_NewEnum', 'SpeechDataKeyLocation',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SASetState',
    'DISPID_SVVoice', 'DISPID_SPRuleName', 'SpeechEngineConfidence',
    'SPBOOKMARKOPTIONS', 'SpNotifyTranslator',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRSSupportedLanguages', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLPType', 'eLEXTYPE_PRIVATE1', 'SPRECORESULTTIMES',
    'DISPID_SBSFormat', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SGRSRule', 'SREBookmark', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechLexiconWord', 'ISpGrammarBuilder',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRProfile', 'SPPS_RESERVED1',
    'DISPID_SpeechRecognizerStatus', 'SPEI_SR_BOOKMARK',
    'SVSFPersistXML', 'DISPID_SOTGetDescription',
    'DISPID_SGRSTPropertyName', 'eLEXTYPE_PRIVATE13',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SVSVisemeId',
    'SDKLCurrentConfig', 'DISPID_SVAudioOutput',
    'DISPID_SpeechRecognizer', 'SDTReplacement', 'SP_VISEME_8',
    'SPRECOCONTEXTSTATUS', 'SDTRule', 'DISPID_SLPs_NewEnum',
    'SAFT12kHz16BitStereo', 'DISPID_SRCEPhraseStart', 'SVP_14',
    'ISpeechRecognizerStatus', 'DISPID_SRCBookmark',
    'SpNullPhoneConverter', 'SPWT_LEXICAL', 'SpeechLoadOption',
    'SPPHRASEPROPERTY', 'DISPID_SWFEBlockAlign', 'SPEI_WORD_BOUNDARY',
    'SRTStandard', 'ISpeechPhraseReplacements', 'SPAS_RUN',
    'STSF_LocalAppData', 'DISPID_SVSpeakStream', 'SVSFlagsAsync',
    'eLEXTYPE_PRIVATE18', 'SPFM_CREATE_ALWAYS',
    'DISPID_SVSInputSentenceLength', 'eLEXTYPE_LETTERTOSOUND',
    'SPAR_High', 'DISPID_SAFGuid', 'DISPID_SVPause',
    'SPPHRASEELEMENT', 'SGRSTTEpsilon', 'DISPID_SRGCmdSetRuleIdState',
    'ISpeechObjectTokenCategory',
    'SpeechGrammarTagUnlimitedDictation', 'SPLEXICONTYPE',
    'ISpProperties', 'DISPID_SRStatus',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRCCreateGrammar', 'SVP_9', 'SpeechVoiceEvents',
    'UINT_PTR', 'SPBO_AHEAD', 'DISPID_SPELexicalForm',
    'DISPID_SOTCDefault', 'SVP_12', 'IInternetSecurityManager',
    'ISpVoice', 'DISPID_SPRulesCount', 'DISPID_SVSPhonemeId',
    'eLEXTYPE_RESERVED8', 'DISPID_SVSLastResult', 'SpeechAudioVolume',
    'SAFT32kHz16BitStereo', 'SPGS_ENABLED', 'SPPHRASERULE',
    'DISPID_SGRSTWeight', 'SVP_6', 'SVEWordBoundary',
    'DISPID_SPRuleConfidence', 'DISPID_SPPNumberOfElements',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SRGetPropertyString',
    'DISPID_SRGCmdLoadFromMemory', 'ISpeechPhraseReplacement',
    'DISPID_SOTGetAttribute', 'SPEI_RECOGNITION',
    'DISPID_SPIElements', 'ISpeechVoice', 'ISpEventSink',
    'ISpeechGrammarRule', 'DISPID_SpeechPhraseRule',
    'SpeechRegistryUserRoot', 'DISPID_SRState',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCreateRecoContext',
    'DISPID_SRCEAdaptation', 'Speech_Max_Pron_Length',
    'DISPID_SGRAddResource', 'ISpeechRecoResultDispatch',
    'SGRSTTDictation', 'SPCS_ENABLED', 'SPFM_OPEN_READWRITE',
    'ISpRecognizer3', 'SVEEndInputStream', 'SECHighConfidence',
    'SAFT22kHz16BitStereo', 'SPSHT_EMAIL', 'SPEI_END_INPUT_STREAM',
    'SpeechStreamSeekPositionType', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'Speech_Max_Word_Length', 'SRATopLevel', 'SVP_1',
    'DISPID_SPIRule', 'DISPID_SGRsItem', 'SpeechLexiconType',
    'DISPID_SPRuleParent', 'SPRST_ACTIVE', 'SP_VISEME_21',
    'ISpeechGrammarRules', 'SpeechPartOfSpeech', 'SPXMLRESULTOPTIONS',
    'SVSFIsXML', 'DISPID_SGRSTNextState', 'DISPID_SGRName',
    'SAFTADPCM_44kHzStereo', 'SVEAudioLevel',
    ...
    'SpeechGrammarTagWildcard', 'SRAONone', 'SP_VISEME_2',
    'SAFT12kHz8BitMono', 'SPEI_FALSE_RECOGNITION',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPEVENTENUM', 'DISPID_SPPsItem',
    'DISPID_SGRClear', 'SGDSActiveWithAutoPause',
    'DISPID_SRGCmdLoadFromResource', 'SpeechTokenValueCLSID',
    '_SPAUDIOSTATE', 'SPSUnknown', 'SPEI_RESERVED5', 'SGRSTTWildcard',
    'SPPS_Modifier', 'SpCustomStream', 'SPEI_VOICE_CHANGE',
    'DISPID_SLPSymbolic', 'SPTEXTSELECTIONINFO', 'SpeechAudioState',
    'SPEVENTSOURCEINFO', 'eLEXTYPE_PRIVATE4',
    'SPEI_RECO_STATE_CHANGE', 'SVSFIsFilename', 'SBOPause',
    'SPSEMANTICERRORINFO', 'SpeechCategoryVoices',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SOTCGetDataKey',
    'SpeechAudioFormatGUIDText', 'DISPID_SVGetVoices',
    'DISPID_SPAsItem', 'SP_VISEME_14', 'SpResourceManager',
    'SPWF_INPUT', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPEDisplayText', 'SREStreamStart', 'SPFM_CREATE',
    'SSTTWildcard', 'SAFTADPCM_8kHzStereo', 'SpeechCategoryAudioIn',
    'DISPID_SVSpeak', 'SpeechInterference', 'SpeechVoicePriority',
    'SPINTERFERENCE_NONE', 'SGLexicalNoSpecialChars',
    'DISPID_SpeechVoiceEvent', 'SAFT16kHz8BitMono', 'SRAExport',
    'SpeechEmulationCompareFlags', 'SGSDisabled',
    'ISpeechPhraseElements', 'SPEI_SOUND_END', 'SPPS_Unknown',
    'SAFT22kHz8BitMono', 'ISequentialStream', 'SPEI_PHRASE_START',
    'ISpeechAudioFormat', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechRecoGrammar', 'SREAllEvents',
    'DISPID_SRCERecognizerStateChange', 'SPEI_SOUND_START',
    'SVF_Stressed', 'ISpPhoneticAlphabetConverter',
    'DISPID_SLRemovePronunciation', 'SBONone', 'SDTAlternates',
    'ISpSerializeState', 'DISPID_SVSkip', 'SPINTERFERENCE_TOOSLOW',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SPPsCount',
    'DISPID_SpeechPhraseElement', 'SPLOADOPTIONS',
    'DISPID_SVDisplayUI', 'SpFileStream', 'SPEI_START_INPUT_STREAM',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPSNotOverriden',
    'SAFTADPCM_11kHzMono', 'SRESoundEnd', 'SPGS_EXCLUSIVE',
    'DISPID_SGRsAdd', 'DISPID_SOTRemove', 'DISPID_SGRSTRule',
    'DISPID_SBSRead', 'SAFT48kHz8BitMono', 'SVP_2', 'SPRECOSTATE',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SAFType', 'SPEI_MIN_SR',
    'SpPhraseInfoBuilder', 'DISPID_SRGDictationSetState', 'SGLexical',
    'DISPID_SLWType', 'SpLexicon', 'DISPID_SPERequiredConfidence',
    'SAFTADPCM_22kHzStereo', 'SPEVENT',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSAddWordTransition',
    'ISpeechVoiceStatus', 'SGRSTTWord', 'SpeechVisemeFeature',
    'SPVPRI_ALERT', 'SPEI_MAX_SR', 'DISPID_SRRecognizer',
    'DISPID_SpeechXMLRecoResult', 'SAFTCCITT_uLaw_22kHzStereo',
    'SPAR_Medium', 'DISPID_SDKEnumKeys', 'SPPS_RESERVED2',
    'DISPID_SPRText', 'SPPS_Verb', 'SAFTGSM610_11kHzMono',
    'SSSPTRelativeToEnd', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SLGetWords', 'DISPID_SPPName', 'SPLO_DYNAMIC',
    'SP_VISEME_18', 'DISPID_SRRTStreamTime', 'SpeechRecognizerState',
    'ISpeechDataKey', 'SPLO_STATIC', 'SRADefaultToActive', 'SPRULE',
    'SREPropertyStringChange', 'SGRSTTTextBuffer',
    'SpeechWordPronounceable', 'DISPID_SPIAudioSizeBytes',
    'IEnumSpObjectTokens', 'LONG_PTR', 'SPDATAKEYLOCATION',
    'tagSPPROPERTYINFO', 'SpeechVoiceCategoryTTSRate',
    'SpeechAudioFormatType', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SLGenerationId', 'DISPID_SPCIdToPhone',
    'ISpeechRecoResultTimes', 'SVPAlert', 'DISPID_SVSRunningState',
    'DISPID_SRRTOffsetFromStart', 'SPSInterjection', 'SPEI_RESERVED6',
    'SECFIgnoreCase', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SWPUnknownWordPronounceable', 'ISpeechRecoResult2', 'SpShortcut',
    'SPRS_INACTIVE', 'ISpeechGrammarRuleState', 'SP_VISEME_11',
    'SECFIgnoreWidth', 'SPBINARYGRAMMAR', 'SPCT_COMMAND',
    'DISPID_SLWLangId', 'ISpeechWaveFormatEx', 'SREHypothesis',
    'SPINTERFERENCE_NOISE', 'DISPID_SGRsFindRule', 'DISPID_SPEsItem',
    'DISPID_SDKSetStringValue', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SDKGetlongValue', 'ISpeechPhoneConverter', 'SRAImport',
    'DISPID_SLWWord', 'SPWORDLIST', 'SPCT_SLEEP', 'ISpeechMMSysAudio',
    'DISPID_SRCEEndStream', 'SVP_4', 'SAFTText', 'SVF_Emphasis',
    'SpVoice', 'DISPID_SRRTimes', 'SLOStatic', 'STSF_AppData',
    'DISPID_SVResume', 'ISpStream', 'SPSHORTCUTPAIR',
    'DISPID_SLPsCount', 'DISPID_SRGetRecognizers',
    'SAFTCCITT_uLaw_22kHzMono', 'eLEXTYPE_PRIVATE19',
    'eLEXTYPE_PRIVATE9', 'DISPID_SRRRecoContext', 'DISPID_SVEViseme',
    'SPSHORTCUTTYPE', 'SPSERIALIZEDRESULT', 'SINoSignal',
    'DISPID_SRCEFalseRecognition', 'SPVPRIORITY',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SWFEFormatTag',
    'DISPID_SPIEngineId',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SpeechRecoResult2', 'eLEXTYPE_RESERVED7', 'SASClosed',
    'SPWF_SRENGINE', 'SPPS_Noun', 'SAFTADPCM_44kHzMono', 'ISpDataKey',
    'SDA_One_Trailing_Space', 'DISPIDSPTSI', 'eLEXTYPE_PRIVATE17',
    'SPEI_RESERVED1', 'DISPID_SPEDisplayAttributes',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPRules_NewEnum',
    'SAFT48kHz16BitStereo', 'DISPID_SRCEStartStream', 'SVEPrivate',
    'SP_VISEME_17', 'eLEXTYPE_PRIVATE10', 'SAFTGSM610_8kHzMono',
    'DISPID_SPRFirstElement', 'eLEXTYPE_PRIVATE7',
    'ISpObjectTokenCategory', 'SGDSInactive', 'ISpRecoGrammar',
    'SP_VISEME_13', 'SDTLexicalForm', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechLexicon', 'SDA_No_Trailing_Space',
    'DISPID_SWFEChannels', 'ISpMMSysAudio', 'SRTSMLTimeout',
    'SRESoundStart', 'SpMMAudioOut',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_5',
    'DISPID_SPIStartTime', 'DISPID_SLPPartOfSpeech',
    'SAFTCCITT_uLaw_44kHzMono', 'DISPID_SABIMinNotification',
    'eLEXTYPE_RESERVED10', 'DISPID_SPEsCount', 'SAFT24kHz16BitStereo',
    'DISPID_SRRGetXMLResult', 'DISPID_SpeechObjectTokens',
    'ISpeechPhraseInfoBuilder', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'eLEXTYPE_PRIVATE15', 'SAFTCCITT_ALaw_11kHzStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SpStreamFormatConverter',
    'SpeechPropertyNormalConfidenceThreshold', 'DISPID_SMSALineId',
    'Speech_StreamPos_Asap', 'tagSPTEXTSELECTIONINFO',
    'SPFM_NUM_MODES', 'DISPID_SLAddPronunciation', 'SVSFIsNotXML',
    'SPSHT_Unknown', 'SVP_3', 'SRTExtendableParse', 'SPCS_DISABLED',
    'SVF_None', 'SpeechCategoryPhoneConverters', 'STCAll',
    'SpObjectToken', 'SDTDisplayText', 'SPWAVEFORMATTYPE',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFTNoAssignedFormat',
    'DISPID_SRCState', 'DISPID_SPRuleNumberOfElements',
    'SPINTERFERENCE_TOOLOUD', 'ISpeechPhraseElement',
    'ISpXMLRecoResult', 'DISPID_SBSSeek', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechObjectToken', 'SLTApp', 'DISPID_SLWsCount',
    'eLEXTYPE_PRIVATE12', 'SVP_0', 'SASStop', 'ISpeechRecognizer',
    'DISPID_SPPConfidence', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SDKGetStringValue', 'SPVPRI_OVER', 'ISpeechMemoryStream',
    'SPSHT_NotOverriden', 'SGSEnabled', 'SPSTREAMFORMATTYPE',
    'DISPID_SPRsItem', 'DISPID_SABIBufferSize', 'SpWaveFormatEx',
    'DISPID_SpeechMemoryStream', 'DISPID_SGRInitialState',
    'DISPID_SFSClose', 'eLEXTYPE_PRIVATE6'
]
